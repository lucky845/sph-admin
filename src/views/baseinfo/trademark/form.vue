  ...
  <div class="app-container">
    <el-form label-width="120px">
      <el-form-item label="标题">
        <el-input v-model="trademark.brandName"/>
      </el-form-item>
      ...
      <el-form-item label="Logo">
        <el-upload
          ...
          :action="'http://api.gmall.com/product/brand/fileUpload'"
          class="avatar-uploader">
          <img :src="trademark.brandLogoUrl">
        </el-upload>
      </el-form-item>
...
const defaultForm = {
  brandName: '',
  brandLogoUrl: '/static/default.jpg'
}
...
export default {
  ...
  methods: {
    ...
    saveData() {
      trademarkApi.save(this.trademark).then(response => {
        ...
        if (response.code) {
          ...
          this.$router.push({ path: '/baseinfo/trademark/list' })
        }
      })
    },
    ...
    // 根据id查询记录
    fetchDataById(id) {
      trademarkApi.getById(id).then(response => {
        //
    ...
    handleImageUrlSuccess(response) {
      this.trademark.brandLogoUrl = response.data
    },
